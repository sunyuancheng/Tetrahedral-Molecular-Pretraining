...
@dataclass
class LBAFinetuneConfig(FairseqDataclass):
    ...
    loss_type: str = field(
        default="L1",
        metadata={
            "help": "loss type, L1 or L2 or SmoothL1"
        }
    )
...
@register_task("lba_finetune", dataclass=LBAFinetuneConfig)
class LBAFinetuneTask(FairseqTask):
    """
