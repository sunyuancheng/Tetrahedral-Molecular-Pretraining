...
@dataclass
class MD17FinetuneConfig(FairseqDataclass):
    ...
    train_size: int = field(
        default=9500,
        metadata={"help": "datasize use for training"}
    )
...
@register_task("md17_finetune", dataclass=MD17FinetuneConfig)
class MD17FinetuneTask(FairseqTask):
    """
