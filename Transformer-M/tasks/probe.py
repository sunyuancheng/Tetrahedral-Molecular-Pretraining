...
@dataclass
class FunctionalGroupProbeConfig(FairseqDataclass):
...
@register_task("fg_probing", dataclass=FunctionalGroupProbeConfig)
class FunctionalGroupProbeTask(FairseqTask):
    """
